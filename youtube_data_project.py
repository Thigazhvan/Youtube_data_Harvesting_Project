...
def Api_connect():
    Api_Id="AIzaSyBXFpbFDQxdJtg1k6GpUGsK9QnJXdv0XmY"
...
#streamlit part
st.text("project_1")
st.title(":green[youtube_data_harvesting_project]")
channel_id=st.text_input("channel id")
if st.button("store channel details in Mongo DB"):
    ch_ids=[]
    db=client["Youtube_data"]
    coll1=db["channel_details"]
    for ch_data in coll1.find({},{"_id":0,"channel_information":1}):
...
show_table=st.selectbox("Select Tables",("channels","playlist","videos","comments"))
...
question=st.selectbox("Questions",("1. All the videos and the channel name",
